...
function showJoke() {
  ...
  const jokesContainer = document.querySelector(".jokes-content");
  const newJokes = document.createElement("p");
  newJokes.textContent = randomJokeText;
  clearAll();
  jokesContainer.appendChild(newJokes);
}
...
function showQuote() {
  ...
  qoutecontainer.appendChild(newQuote);
  qoutecontainer.appendChild(newAuthor);
}
...
function showRiddle() {
  ...
  answerRiddle.textContent = "the answer is: " + answer;
  answerRiddle.setAttribute("id", "riddle-answer");
  answerRiddle.hidden = true;

  clearAll();

  riddlecontainer.appendChild(newRiddle);
  riddlecontainer.appendChild(answerRiddle);
}
...
function revealAnswers() {
  ...
  if (riddle && answer.hidden) {
    ...
    alert("the answer is aready revealed");
  } else if (!riddle) {
